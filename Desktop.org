...
optimus-manager-qt &
# wallpaper
wget https://source.unsplash.com/random/2560x1440/?nasa -O ~/.wallpaper.jpg
...
modules-right = wlan cpu memory eth temperature_cpu temperature_gpu root arch-updates battery date bspwm
modules-center =
modules-left =
tray-position = left
tray-padding = 5

...
optimus-manager-qt &
# wallpaper
feh --bg-center ~/Cloud/Images/SelfMadeWallpaper/ice.png /data/Cloud/Images/SelfMadeWallpaper/ice.png
# bluetooth
blueman-applet &
# wm fix phpstorm
wmname LG3D &
...
modules-left = bspwm
modules-center =
modules-right = wlan cpu memory eth temperature_cpu temperature_gpu root arch-updates battery date
tray-position = right
tray-padding = 5
